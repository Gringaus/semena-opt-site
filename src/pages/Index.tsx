...
const Index = () => {
  ...
  useDocumentMeta({
    title: '',
    description: 'Оптовый магазин семян в Иваново: овощные, цветочные и полевые культуры. Более 560 сортов, прямые контракты с селекционными станциями, всхожесть 97%. Доставка по Иваново и области. Заявки на сезон 2026.',
    ogType: 'website',
