...
const Index = () => {
  ...
  useDocumentMeta({
    title: 'Семена оптом от производителя в Иваново — овощи, цветы, газонная трава | 560+ сортов',
    description: 'Семена оптом от производителя в Иваново и Ивановской области: овощные, цветочные, полевые культуры и газонная трава. 560+ сортов напрямую от селекционных станций, всхожесть 97%, прайс на семена оптом, доставка по городу Иваново и области. Заявки на сезон 2026.',
    ogType: 'website',
