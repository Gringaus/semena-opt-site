...
const PrivacyPage = () => {
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <article className="container py-16 lg:py-24 max-w-4xl">
        <div className="text-xs uppercase tracking-[0.25em] text-[hsl(var(--earth))] mb-3">Документ</div>
        <h1 className="font-display text-4xl lg:text-6xl leading-[1] mb-10">Политика в отношении обработки персональных данных</h1>

        <div className="prose prose-neutral max-w-none text-base leading-relaxed space-y-6">
          <section>
            <h2 className="font-display text-2xl lg:text-3xl mt-8 mb-4">1. Общие положения</h2>
            ...
            <p>1.2. Настоящая политика Оператора в отношении обработки персональных данных (далее — Политика) применяется ко всей информации, которую Оператор может получить о посетителях веб-сайта https://semena37.ru.</p>
          </section>

          <section>
            <h2 className="font-display text-2xl lg:text-3xl mt-8 mb-4">2. Основные понятия, используемые в Политике</h2>
            <p>2.1. Автоматизированная обработка персональных данных — обработка персональных данных с помощью средств вычислительной техники.</p>
            <p>2.2. Блокирование персональных данных — временное прекращение обработки персональных данных (за исключением случаев, если обработка необходима для уточнения персональных данных).</p>
            <p>2.3. Веб-сайт — совокупность графических и информационных материалов, а также программ для ЭВМ и баз данных, обеспечивающих их доступность в сети интернет по сетевому адресу https://semena37.ru.</p>
            ...
            <p>2.8. Персональные данные — любая информация, относящаяся прямо или косвенно к определенному или определяемому Пользователю веб-сайта https://semena37.ru.</p>
            <p>2.9. Персональные данные, разрешенные субъектом персональных данных для распространения, — персональные данные, доступ неограниченного круга лиц к которым предоставлен субъектом персональных данных путем дачи согласия на обработку персональных данных, разрешенных субъектом персональных данных для распространения в порядке, предусмотренном Законом о персональных данных (далее — персональные данные, разрешенные для распространения).</p>
            <p>2.10. Пользователь — любой посетитель веб-сайта https://semena37.ru.</p>
          ...
          <section>
            <h2 className="font-display text-2xl lg:text-3xl mt-8 mb-4">3. Основные права и обязанности Оператора</h2>
          ...
          <section>
            <h2 className="font-display text-2xl lg:text-3xl mt-8 mb-4">4. Основные права и обязанности субъектов персональных данных</h2>
          ...
          <section>
            <h2 className="font-display text-2xl lg:text-3xl mt-8 mb-4">5. Принципы обработки персональных данных</h2>
          ...
          <section>
            <h2 className="font-display text-2xl lg:text-3xl mt-8 mb-4">6. Цели обработки персональных данных</h2>
          ...
          <section>
            <h2 className="font-display text-2xl lg:text-3xl mt-8 mb-4">7. Условия обработки персональных данных</h2>
          ...
          <section>
            <h2 className="font-display text-2xl lg:text-3xl mt-8 mb-4">8. Порядок сбора, хранения, передачи и других видов обработки персональных данных</h2>
          ...
          <section>
            <h2 className="font-display text-2xl lg:text-3xl mt-8 mb-4">9. Перечень действий, производимых Оператором с полученными персональными данными</h2>
          ...
          <section>
            <h2 className="font-display text-2xl lg:text-3xl mt-8 mb-4">10. Трансграничная передача персональных данных</h2>
          ...
          <section>
            <h2 className="font-display text-2xl lg:text-3xl mt-8 mb-4">11. Конфиденциальность персональных данных</h2>
            <p>Оператор и иные лица, получившие доступ к персональным данным, обязаны не раскрывать третьим лицам и не распространять персональные данные без согласия субъекта персональных данных, если иное не предусмотрено федеральным законом.</p>
          </section>

          <section>
            <h2 className="font-display text-2xl lg:text-3xl mt-8 mb-4">12. Заключительные положения</h2>
            ...
            <p>12.3. Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу https://semena37.ru/privacy.</p>
          </section>
        </div>
      </article>
    </div>
